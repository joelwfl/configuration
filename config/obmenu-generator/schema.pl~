...
## Text editor
my $editor = 'urxvt -e vim';

our $SCHEMA = [
    #          COMMAND                 LABEL                ICON
    {item => ['ranger .',        'File Manager',      'file-manager']},
    {item => ['urxvt',             'Terminal',          'terminal']},
    {item => ['xdg-open http://',  'Web Browser',       'web-browser']},
            {item      => ['openbox --reconfigure',               'Reconfigure Openbox', 'openbox']},
    {item => ['gmrun',             'Run command',       'system-run']},
    {item => ["urxvt -name mutt -e mutt", "mutt", "icon"]},
    {item => ["urxvt -name ranger -e ranger", "ranger", "icon"]},
    {sep => 'Applications'},
    ...
    {begin_cat => ['Advanced Settings', 'gnome-settings']},
        ...
        {begin_cat => ['Openbox', 'openbox']},
            {item      => ['openbox --reconfigure',               'Reconfigure Openbox', 'openbox']},
            {item      => ['obconf',               'Openbox Configuration', 'openboxconf']},
            {item      => ["$editor /home/joel/.config/openbox/autostart.sh", 'Openbox Autostart',    $editor]},
            {item      => ["$editor /home/joel/.config/openbox/rc.xml",    'Openbox RC',           $editor]},
            {item      => ["$editor /home/joel/.config/openbox/menu.xml",  'Openbox Menu',         $editor]},
            {item      => ["$editor /home/joel/.Xresources",  '.Xresources',         $editor]},
        {end_cat => undef},

        # Pacman category
        {begin_cat => ['Misc']},
             {item => ["remmina", "SSH browser", "icon"]},
             {item => ["urxvt -name mutt -e mutt", "mutt", "icon"]},
             {item => ["lxappearance", "lxappearance", "icon"]},
             {item => ["font-manager", "font-manager", "font-manager"]},
             {item => ["bmpanel2cfg", "bmpanel2cfg", "bmpanel2cfg"]},
        {end_cat => undef},
    {end_cat => undef},
    {sep => undef},
    ...
    {item => ['openbox --restart', 'Restart', 'restart']},
    # This option uses the default Openbox's action "Exit"
    {exit => ['Exit', 'exit']},
    {item => ['setxkbmap -option terminate:ctrl_alt_bksp', 'Restart', 'restart']},
]
